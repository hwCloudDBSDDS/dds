...
def open_file_graph_test(file_name, mode='r', encoding=None, **kwargs):
...
class TestGraphMethods(unittest.TestCase, CustomAssertions):
    ...
    def test_export_to_json(self):
        ...
        generated = open_file_graph_test("export_test.json", "r")
        correct = open_file_graph_test("test_graph.json", "r")
