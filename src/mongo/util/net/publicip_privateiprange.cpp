...
namespace mongo {
    ...
    bool PublicIpPrivateIpRange::parsePrivateIpRange(std::string& range, std::map<__uint128_t, IpRange>& tmpRangeMap) {
        // parse each item
    ...
    void PublicIpPrivateIpRange::parsePublicIp(std::string publicIp, std::map<std::string, std::vector<std::string>>& tmpPublicIpMap) {
