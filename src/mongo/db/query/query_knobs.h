...
extern AtomicBool internalQueryStageMemUsageSwitch;  // NOLINT

extern AtomicInt64 internalQueryStageMemUsageMAX;  // NOLINT

extern AtomicInt64 internalQueryStageMemUsageMIN;  // NOLINT
}  // namespace mongo
