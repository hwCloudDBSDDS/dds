...
class ClusterStartSessionCommand final : public BasicCommand {
    MONGO_DISALLOW_COPYING(ClusterStartSessionCommand);

public:
    ClusterStartSessionCommand() : BasicCommand("startSession") {}
    ...
    virtual bool run(OperationContext* opCtx,
        ...
        LOG(1) << "startSessionCmd " << dbName << " " << nss;
