...
(function() {
    ...
    authenticatedConn.getDB('admin').auth("admin", "Password@a1b");
    ...
    inputOutputAuthConn.getDB('input').auth("admin", "Password@a1b");
    inputOutputAuthConn.getDB('output').auth("admin", "Password@a1b");
    ...
    inputAuthConn.getDB('input').auth("admin", "Password@a1b");
    ...
    outputAuthConn.getDB('output').auth("admin", "Password@a1b");
