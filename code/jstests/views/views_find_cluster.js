...
(function() {
    ...
    var db = new ShardingTest({shards: 2});
    let viewsDB = db.getDB("views_find");
    ...
    let assertFindResultEq = function(cmd, expected, ordered) {
        ...
        let arr = new DBCommandCursor(viewsDB.getMongo(), res, 5).toArray();
    ...
    assertFindResultEq(
        {find: "identityView", limit: 1, batchSize: 1, projection: {_id: 1}},
        [{_id: "New York"}]);
