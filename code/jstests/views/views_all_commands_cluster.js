...
(function() {
    ...
    let viewsCommandTests = {
        ...
        cloneCollectionAsCapped: {skip: "not support"},
        ...
        convertToCapped: {skip: "not support"},
        ...
        dropRole: { skip: "not support"},
        dropUser: {skip: isUnrelated},
        /*emptycapped: {
            command: {emptycapped: "view"},
            expectFailure: true,
        },*/
        emptycapped: { skip: "not support"},
        ...
        getShardVersion: {skip: "not support"},
        ...
        */
        mapReduce: {skip: "not support"},
        mergeChunks: {skip: "not support"},
         moveChunk: {skip: "not support"},
        ...
        parallelCollectionScan: { skip: "not support"},
        ping: {command: {ping: 1}},
        ...
        renameCollection: {skip: "not support"},
        //repairCursor: {command: {repairCursor: "view"}, expectFailure: true},
        repairCursor: {skip: "not support"},
        ...
        revokePrivilegesFromRole: {skip: "not support"},
        ...
        split: {skip: "not support"},
        splitChunk: {skip: "not support"},
        splitVector: {skip: "not support"},
