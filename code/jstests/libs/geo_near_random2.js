GeoNearRandomTest2 = function(db,name) {
    this.name = name;
    this.t = db[name];
    this.nPts = 0;
...
GeoNearRandomTest2.prototype.mkPt = function mkPt(scale, indexBounds) {
    if (!indexBounds) {
...
GeoNearRandomTest2.prototype.insertPts = function(nPts, indexBounds, scale) {
...
GeoNearRandomTest2.prototype.assertIsPrefix = function(short, long) {
...
GeoNearRandomTest2.prototype.testPt = function(pt, opts) {
