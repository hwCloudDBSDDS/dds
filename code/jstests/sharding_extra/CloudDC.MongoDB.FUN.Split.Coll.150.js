(function() {
    'use strict';
        ...
        assert.commandWorked(admin.runCommand({shardCollection:"testDB.foo",key:{a:"hashed"},unique:false,numInitialChunks:2}));
	...
	var bulk = coll.initializeUnorderedBulkOp();
		...
		assert.commandWorked(admin.runCommand({split: "testDB.foo",find :{a : 100}}));
