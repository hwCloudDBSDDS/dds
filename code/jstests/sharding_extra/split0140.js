(function() {
    'use strict';
        ...
        jsTest.log("-------------------splite-------------------");
		var mid=Number(100.1)
        //assert.commandWorked(admin.runCommand({split: "testDB.foo",manualsplit:true,find :{a : mid}}));
		assert.commandWorked(admin.runCommand({split: "testDB.foo",middle :{a : mid}}));
        printShardingStatus(st.config,false);
