(function() {
    'use strict';
        ...
        //assert.commandWorked(admin.runCommand({split: "testDB.foo", manualsplit:true,find :{a : "aaa"+ransp}}));
		assert.commandWorked(admin.runCommand({split: "testDB.foo",middle :{a : "aaa"+ransp}}));
        printShardingStatus(st.config,false);
