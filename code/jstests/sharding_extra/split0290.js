(function() {
    'use strict';
        ...
        //assert.commandWorked(admin.runCommand({split: "testDB.foo", manualsplit:true,find :{a : ransp,b:ransp}}));
	assert.commandWorked(admin.runCommand({split: "testDB.foo",middle :{a : ransp,b:ransp}}));
        printShardingStatus(st.config,false);
