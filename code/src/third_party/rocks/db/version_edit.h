...
struct FileDescriptor {
  ...
  KeyRangeCheckResult range_check_result;
  ...
  FileDescriptor(uint64_t number, uint32_t path_id, uint64_t _file_size)
      : table_reader(nullptr),
        ...
        range_check_result(KeyRangeCheckResult::RangeUnknown) {}

  FileDescriptor& operator=(const FileDescriptor& fd) {
    table_reader = fd.table_reader;
    packed_number_and_path_id = fd.packed_number_and_path_id;
    file_size = fd.file_size;
    range_check_result = fd.range_check_result;
    return *this;
  }
...
class VersionEdit {
 public:
  ...
  // split-feature: support split DB
  // the last seq has completed the encoding
  SequenceNumber GetLastEncodedSequence()const {return last_encoded_sequence_;}
 ...
 private:
  ...
  // split-feature: support split DB
  // the last seq has completed the encoding
  SequenceNumber last_encoded_sequence_;
