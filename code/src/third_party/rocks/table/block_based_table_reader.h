...
class BlockBasedTable : public TableReader {
 public:
  ...
  static Status Open(const ImmutableCFOptions& ioptions,
                     ...
                     const bool do_range_check = false);
 ...
 protected://change from private to protected by split db
  ...
  friend class BlockEntryIteratorState;
  ...
  explicit BlockBasedTable(Rep* rep = nullptr)
...
class BlockEntryIteratorState : public TwoLevelIteratorState {
 public:
  BlockEntryIteratorState(BlockBasedTable* table,
      ...
      : TwoLevelIteratorState(table->GetIOptions().prefix_extractor !=
                              nullptr),
        table_(table),
  ...
  InternalIterator* NewSecondaryIterator(const Slice& index_value) override {
    return BlockBasedTable::NewDataBlockIterator(table_->rep_, read_options_, index_value);
  }
