...
namespace mongo {
    ...
    public:
        ...
        virtual RocksRecoveryUnit* newRocksRecoveryUnit() {
            return new RocksRecoveryUnit(GetSnapshotManager(), _db);
        }
...
//    private:
        ...
        bool isBelongRightDB(rocksdb::WriteBatchWithIndex* wb, ChunkRocksDBInstance* db);
        ...
        RocksSnapshotManager* GetSnapshotManager() { return _snapshotManager; }
        const RocksSnapshotManager* GetSnapshotManager() const { return _snapshotManager; }
