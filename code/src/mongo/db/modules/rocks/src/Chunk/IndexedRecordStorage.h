...
namespace mongo {
    ...
    public:
        ...
        virtual rocksdb::Status GenerateRecord(
            ...
            std::pair<std::string, std::string>& recordKeyValuePair) const = 0;

        //
        //  Take RocksDB record and tries to restore original MongoDB  index
        //
        virtual rocksdb::Status ParseRecord(
            const std::pair<rocksdb::Slice, rocksdb::Slice>& indexKeyValuePair, mongo::BSONObj* key,
            mongo::RecordId* documentRecordId) const = 0;
    ...
    public:
        ...
        virtual rocksdb::KeyRangeCheckResult DoesKeyRangeBelongToChunk(
            const rocksdb::Slice& keyLow, const rocksdb::Slice& keyHigh) const {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    //
    //  Interface describes class, which is responsible for convertion of MongoDB documents into
    //  RocksDB records.
    ...
    public:  //  Interface members
        ...
        //  Column family descriptor can contain Compaction filter to filter out rows after the
        //  split
        //
        virtual const std::vector<const IChunkColumnFamilyDescription*>&
        GetColumnFamilyDescriptions() const = 0;

        //
        //  Optional initialization stage which allows loading some saved data from database.
        //  like statistics or auto-increments
        //
        virtual rocksdb::Status Init(ChunkRocksRecordStore& recordStore) {
        ...
        //
        //  Parse Rocks key to get RecordId. TODO: consider using IIndexRecordFormatter for main
        //  data family for that.
        //
        ...
        virtual std::unique_ptr<IIndexRecordFormatter> GetSecondaryIndexFormatter(
            const IndexDefinition& index) const = 0;
        ...
        //
        //  Id of the column family to store arbitrary chunk-related data, like statistics or
        //  metadata
        //
    ...
    public:  //  Static functions
        ...
        //
        static rocksdb::Status Create(const ChunkMetadata& metadata,
