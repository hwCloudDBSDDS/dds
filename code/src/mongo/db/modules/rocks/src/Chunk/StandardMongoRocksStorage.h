...
public:
    ...
    virtual std::string GetLowKey(void) 
    { 
        return std::string(); 
    }

    virtual std::string GetHighKey(void) 
    { 
        return std::string(); 
    }
