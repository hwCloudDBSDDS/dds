...
#define MDB_RIF(op)                                                 \
    {                                                               \
        ...
        if (!ResultHandling::IsOK(____result)) {                    \
            return ResultHandling::LogErrorReturn(                  \
                ____result, #op, __FILE__, __LINE__, __FUNCTION__); \
        }                                                           \
    }
...
inline mongo::Status LogErrorReturn(StatusT& result,
                                    const char* operationText,
                                    const char* file,
                                    int line,
...
inline mongo::Status& LogErrorReturn(mongo::Status& result,
                                     const char* operationText,
                                     const char* file,
                                     int line,
                                     const char* function) {
