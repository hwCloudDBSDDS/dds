...
const uint32_t kShardActiveReadyTimeoutMS = 1000 + kIsMasterTimeoutMS + 
                 kShardIdentityUpsertTimeoutMS + kShardVersionTimeoutMS;
...
const uint32_t kFindOrGetMoreTimeoutMS(10000);
